  ...
  return(
    <div className="container search-container">
      ...
      <div className="row justify-content-center">
        <div className="row col-10 justify-content-center search-row input-group input-group-lg">
        ...
        <div className="row col-10 justify-content-center search-row input-group input-group-lg">
          ...
          <input className="col-10 " name="startDate" id="startYear" onChange={props.change} placeholder="enter a date formatted as YYYMMDD"/>
        </div>
        <div className="row col-10 justify-content-center search-row input-group input-group-lg">
          <h4 className="text-left col-10">End Date</h4>
          <input className="col-10" name="endDate" id="endYear" onChange={props.change} placeholder="enter a date formatted as YYYMMDD"/>
        </div>
